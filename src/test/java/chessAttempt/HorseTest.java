...
public class HorseTest extends GamePieceTest{
	...
	public void atEdgesOfBoard() {
		...
		Set<Coordinates> actualPermissibleMoves5 = gameBoard.board[1][1].permissibleMoves(gameBoard.board);
		Set<Coordinates> actualPermissibleMoves6 = gameBoard.board[1][6].permissibleMoves(gameBoard.board);
		Set<Coordinates> actualPermissibleMoves7 = gameBoard.board[6][6].permissibleMoves(gameBoard.board);
		Set<Coordinates> actualPermissibleMoves8 = gameBoard.board[6][1].permissibleMoves(gameBoard.board);
