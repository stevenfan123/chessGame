...
public class PawnTest extends GamePieceTest{
	...
	public void forwardTwoSpaces() {
		...
		Set<Coordinates> actualPermissibleMoves1 = gameBoard.board[0][1].permissibleMoves(gameBoard,true);
		Set<Coordinates> actualPermissibleMoves2 = gameBoard.board[2][1].permissibleMoves(gameBoard,true);
		Set<Coordinates> actualPermissibleMoves3 = gameBoard.board[3][1].permissibleMoves(gameBoard,true);
		Set<Coordinates> actualPermissibleMoves4 = gameBoard.board[4][1].permissibleMoves(gameBoard,true);
		Set<Coordinates> actualPermissibleMoves5 = gameBoard.board[5][1].permissibleMoves(gameBoard,true);
	...
	public void forwardOneSpace() {
		...
		Set<Coordinates> actualPermissibleMoves1 = gameBoard.board[0][2].permissibleMoves(gameBoard,true);
		Set<Coordinates> actualPermissibleMoves2 = gameBoard.board[2][2].permissibleMoves(gameBoard,true);
		Set<Coordinates> actualPermissibleMoves3 = gameBoard.board[3][2].permissibleMoves(gameBoard,true);
		Set<Coordinates> actualPermissibleMoves4 = gameBoard.board[0][6].permissibleMoves(gameBoard,true);
		Set<Coordinates> actualPermissibleMoves5 = gameBoard.board[1][7].permissibleMoves(gameBoard,true);
	...
	public void forwardDiagnoal() {
		...
		expectedPermissibleMoves3.add(new Coordinates(4,4));
		Set<Coordinates> actualPermissibleMoves1 = gameBoard.board[1][2].permissibleMoves(gameBoard,true);
		Set<Coordinates> actualPermissibleMoves2 = gameBoard.board[6][2].permissibleMoves(gameBoard,true);
		Set<Coordinates> actualPermissibleMoves3 = gameBoard.board[4][3].permissibleMoves(gameBoard,true);
		Set<Coordinates> actualPermissibleMoves4 = gameBoard.board[0][6].permissibleMoves(gameBoard,true);
		Set<Coordinates> actualPermissibleMoves5 = gameBoard.board[7][6].permissibleMoves(gameBoard,true);
		Set<Coordinates> actualPermissibleMoves6 = gameBoard.board[4][7].permissibleMoves(gameBoard,true);
		assertEquals(expectedPermissibleMoves1, actualPermissibleMoves1);
		assertEquals(expectedPermissibleMoves2, actualPermissibleMoves2);
		assertEquals(expectedPermissibleMoves3, actualPermissibleMoves3);
		assertEquals(expectedPermissibleMoves4, actualPermissibleMoves4);
